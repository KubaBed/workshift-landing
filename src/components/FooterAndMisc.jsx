...
export function CTASection() {
    ...
    return (
        ...
        <section id="darmowa-konsultacja" className="py-32 bg-black relative overflow-hidden">
            ...
            {/* Decorative overlay */}
            <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-lime rounded-full blur-[150px] opacity-10 -translate-y-1/2 translate-x-1/2 pointer-events-none" />
            ...
            {isModalOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                    ...
                    <motion.div
                        ...
                        className="relative w-full max-w-4xl max-h-[90vh] bg-white rounded-[10px] shadow-2xl overflow-hidden flex flex-col z-10"
                    >
