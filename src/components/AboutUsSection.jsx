                    ...
                    <div className="lg:col-span-5 relative">
                        ...
                        >
                            {/* Founder Image Placeholder */}
                                ...
                                {/* Overlay Solid Badge */}
                                <div className="absolute bottom-6 left-6 right-6 p-4 rounded-2xl bg-white flex items-center justify-between border border-slate-100 shadow-xl z-20">
                                    <div className="flex items-center gap-3">
                                        <div className="w-10 h-10 rounded-full overflow-hidden border border-slate-200">
                                           <img src={jakubPhoto} alt="Avatar" className="w-full h-full object-cover" />
                                        </div>
                                        <div className="flex flex-col">
                                            <p className="font-bold text-navy text-sm">@jakubbednarz</p>
                                            <p className="text-[11px] text-slate-500 font-medium mt-0.5">Prezes Zarządu</p>
                                        </div>
                                    </div>
                                    <a href="https://www.linkedin.com/in/jakubbednarz/" target="_blank" rel="noopener noreferrer" className="h-9 px-4 rounded-full bg-navy text-white text-xs font-bold hover:bg-navy-dark transition-colors flex items-center gap-2">
